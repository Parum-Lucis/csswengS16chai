      ...
      <h1 className="text-center text-5xl font-bold text-primary mb-4 font-sans">Event List</h1>
       ...
       <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between mb-4">
        ...
        >
          ...
          <option className="bg-secondary text-white" value="">Ongoing</option>
          <option className="bg-secondary text-white" value="">Archived</option>
        </select>
        ...
        >
          ...
          <option className="bg-secondary text-white" value="">A - Z</option>
          <option className="bg-secondary text-white" value="">Latest Event</option>
          <option className="bg-secondary text-white" value="">Oldest Event</option>
        </select>
