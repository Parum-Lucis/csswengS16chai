...
export const callImportBeneficiaries = httpsCallable<string, boolean>(func, 'importBeneficiaries');
export const callImportEvents = httpsCallable<string, boolean>(func, 'importEvents');
export const callImportVolunteers = httpsCallable<string, boolean>(func, 'importVolunteers');
