...
function ProfileDetails(){
    ...
    return (
        <div className=' flex items-center justify-center h-[100vh]'>
            <div className='overflow-hidden flex items-center justify-center w-[65vh] h-[90vh] bg-[#254151] rounded-[5px] pb-[15px]'>
                ...
                <div className='z-0 flex flex-col relative top-[7%]'>
                    <div className='flex flex-col w-[61vh] h-[50vh]  overflow-hidden bg-[#45B29D] rounded-[5px] p-[9px] pt-20 '>
                        ...
                        {isID && <h3 className="flex text-[#254151] text-[2vh] justify-center font-[Montserrat] font-regular">id: {user.id} </h3>} 
